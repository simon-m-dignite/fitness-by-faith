          ...
          <div className="bg-white rounded-lg p-4" key={index}>
            <div className="w-full flex items-center gap-3">
              {!mail?.userId?.profilePicture ? (
                <img src={ImagePlaceHolder} alt="" className="block w-14 h-14 rounded-full object-cover"/>
              ) : (
                <img src={mail?.userId?.profilePicture} alt="mail" className="block w-14 h-14 rounded-full object-cover"/>
              )}
